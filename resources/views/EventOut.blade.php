@extends('layout.backend.app',[
    ...
    @csrf
    <div class="card">
    <h1 class="h3 mb-4 text-gray-800">Check-OUT Event</h1>
    ...
    <div id="video-container">
        ...
        <button id="click-photo" class="btn btn-primary mt-2"><i class="fas fa-camera"></i>Check Out Now</button>
    </div>
