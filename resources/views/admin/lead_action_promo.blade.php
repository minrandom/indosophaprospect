@extends('layout.backend.app', ['title' => 'Lead to Promo'])
...
<div class="container-fluid">
    ...
    <div class="card shadow border-0 mb-4" style="border-radius:1rem;">
        <div class="card-body">
            <h4 class="mb-3">Lead Action - Change to Promo</h4>
    ...
    <form method="POST" action="{{ route('missions.task.lead.promo.submit', $task->id) }}">
        @csrf
        ...
        <div class="card shadow border-0" style="border-radius:1rem;">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="small text-uppercase text-muted">Promo Comment</label>
                    <textarea name="promo_comment" class="form-control" rows="4" required>{{ old('promo_comment') }}</textarea>
                    @error('promo_comment')
            ...
            <div class="card-footer bg-white text-right">
                ...
                <button type="submit" class="btn btn-info">Submit Promo Request</button>
            </div>
        </div>
    </form>
