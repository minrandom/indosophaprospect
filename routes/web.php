...
Route::group(['namespace' => 'Admin','middleware' => 'auth','prefix' => 'admin'],function(){
	...
	Route::PATCH('/prospect/droprequestdata/{dropRequest}/update',[DropRequestController::class,'update'])->name('admin.prospect.dropupdate')->middleware(['auth', 'role:admin,nsm,bu']);
	Route::POST('/prospect/successrequest',[SuccessReqController::class,'store'])->name('admin.prospect.successreq')->middleware(['auth', 'role:admin,am,nsm,prj,fs,bu']);
	Route::get('/prospect/successrequest',[SuccessReqController::class,'index'])->name('admin.prospect.successlist')->middleware(['auth', 'role:admin,am,nsm,prj,bu']);
