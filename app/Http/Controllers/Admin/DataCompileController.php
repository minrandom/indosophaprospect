            ...
            switch ($data['roles']) {
                case "admin":
                    ...
                    ->whereHas('temperature', function ($query) {
                        $query->WhereIn('tempCodeName', [2, 3, 4,5,-1]);
                    })
                    ->orderBy('status', 'ASC')
            ...
            ->addColumn('action', function ($prp) use ($url) {
                ...
                switch ($prp->status) {
                    ...
                    default:
                        ...
                        $btn = '<div class="row"><a href="javascript:void(0)" id="' . $prp->id . '" class="btn aksi btnaksi btn-warning btn-sm ml-2 btn-validasi">Acceptance</a></div>';
                        // $btn .= '<div class="row mt-1 mr-1"><a href="javascript:void(0)" id="' . $prp->id . '" class="btn aksi btnaksi btn-primary btn-sm ml-2  btn-edit">Edit</a></div>';
